...
spec = Gem::Specification.new do |s|
  extra_doc_list = %w(README COPYRIGHT DONE)
  ...
  s.files     = FileList["{bin,lib,example_configs}/**/*"].to_a + extra_doc_list
  ...
  s.has_rdoc          = true
  s.extra_rdoc_files  = FileList["example_configs/**/*"] + extra_rdoc_files
end
